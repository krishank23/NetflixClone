...
class Video {
    ...
    public function __construct($connect, $input) {
        ...
        if(is_array($input)) {
            ...
            $query = $this->connect->prepare("SELECT * FROM tbl_videos WHERE id=:id");
    ...
    public function incrementViews(){
        $query =  $this->connect->prepare(" UPDATE tbl_videos SET views=views+1 WHERE id=:id ") ;
    ...
    public  function isInProgress($username){
        ...
        $query = $this->connect->prepare("SELECT * FROM tbl_videoProgress
